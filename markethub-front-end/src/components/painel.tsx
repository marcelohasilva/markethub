...
export default function Painel() {
  return (
    <div className="hidden md:flex flex-col justify-center items-center text-center text-white min-h-screen w-[80%] bg-gradient-to-r from-[#8F5CFF] to-[#1A7FF0] p-6 sm:p-8">
