...
const Login = () => {
  ...
  async function handleLogin(e: FormEvent) {
    ...
    try {
      ...
      const message = erro instanceof Error ? erro.message : "Erro ao conectar ao servidor";
  ...
  return (
    <main className="flex min-h-[calc(100vh-82px)] w-full flex-col bg-gradient-to-br from-[#842BFF] via-[#373DE8] to-[#077BF1] md:min-h-[calc(100vh-80px)] md:flex-row md:bg-[#F7F8FC] md:bg-none lg:min-h-[calc(100vh-88px)]">
        ...
        <div className="relative z-10">
          <h1 className="text-[35px] font-bold leading-[1.2] tracking-normal text-white drop-shadow-sm md:text-[44px] xl:text-[44px]">
            ...
            <span className="block text-[35px] leading-[1.2] md:text-[44px] md:leading-[1.2]">
              <span className="text-[#39B7FF]">volta!</span>
            </span>
          </h1>
          <p className="mx-auto mt-[20px] max-w-[330px] text-[18px] font-normal leading-[1.45] text-white/90 md:mx-0 md:max-w-[430px] md:text-[19px] md:leading-[1.55]">
            Faça login para acessar sua conta e continuar aproveitando as
            melhores ofertas.
          </p>
        </div>
      ...
      <section className="flex w-full items-center justify-center px-3 pb-4 pt-0 md:min-h-[calc(100vh-80px)] md:w-[54.3%] md:items-start md:justify-start md:px-[18px] md:py-0 lg:min-h-[calc(100vh-88px)] lg:w-[56.2%] lg:items-center lg:justify-center lg:px-12 lg:py-9">
        <div className="flex w-full max-w-[600px] flex-col rounded-[20px] bg-white px-[30px] pb-[46px] pt-[31px] shadow-[0_24px_70px_rgba(15,23,42,0.10)] sm:px-[50px] sm:py-[37px] md:min-h-[896px] md:max-w-[362px] md:px-[28px] md:pb-[44px] md:pt-[48px] lg:min-h-[904px] lg:max-w-[600px] lg:px-[50px] lg:py-[37px]">
          ...
          <form onSubmit={handleLogin} className="mt-[29px] flex flex-col gap-[18px]">
            ...
            <div>
              <label htmlFor="login-password" className="text-[13px] font-bold leading-none text-[#2F3747]">
                Senha
              </label>
              <div className="relative mt-[9px]">
            ...
            <button
              type="button"
              className="-mt-[4px] w-fit cursor-pointer text-[13px] font-bold text-[#075CFF] hover:underline"
            >
              Esqueci minha senha
            </button>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`mt-[5px] h-[57px] w-full cursor-pointer rounded-[8px] bg-gradient-to-r from-[#8B2CFF] to-[#087BFF] text-[16px] font-bold text-white shadow-[0_10px_24px_rgba(37,99,235,0.18)] transition hover:brightness-105 disabled:cursor-not-allowed ${isLoading ? "opacity-60" : ""}`}
            >
          ...
          <p className="mt-[31px] text-center text-[14px] leading-[1.7] text-[#7B879B]">
            ...
            <button
              ...
              className="ml-2 cursor-pointer font-bold text-[#7C2DFF] hover:underline"
            >
              Criar conta
            </button>
          </p>
